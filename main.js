...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("editForm").onsubmit = function (e) {
    ...
    c.case_name = document.getElementById("editCaseName").value.trim();
    c.citation = document.getElementById("editCitation").value.trim();
    c.year = parseInt(document.getElementById("editYear").value);
    c.court = document.getElementById("editCourt").value.trim();
    c.jurisdiction = document.getElementById("editJurisdiction").value.trim();
    c.summary = document.getElementById("editSummary").value.trim();
    c.legal_principle = document.getElementById("editLegalPrinciple").value.trim();
    c.holding = document.getElementById("editHolding").value.trim();
    ...
    c.case_link = document.getElementById("editCaseLink").value.trim() || null;
    c.full_case_text = document.getElementById("editFullText").value.trim();
  ...
  window.downloadJson = function () {
    ...
    a.href = url;
    a.download = "updated-citations.json";
    a.click();
