...
// Load citations.json on page load
...
// Export current citation to file
...
// Non-functional placeholders to preserve db
function editCitation(index) {
  alert("Edit coming soon. Data integrity preserved.");
}

function deleteCitation(index) {
  alert("Manual deletion only. Data integrity preserved.");
}
